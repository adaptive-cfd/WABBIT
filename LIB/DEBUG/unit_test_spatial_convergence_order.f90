...
! ! WABBIT
! ! ============================================================================================
! !> \name unit_test_spatial_convergence_order.f90
! !> \version 0.5
! !> \author msr
! !
...
! ! ********************************************************************************************
!
! subroutine unit_test_spatial_convergence_order( params, lgt_block, hvy_block, hvy_work, hvy_neighbor, lgt_active, hvy_active, lgt_sortednumlist )
!
! !---------------------------------------------------------------------------------------------
! ! modules
!
...
!     call create_equidistant_base_mesh( params_loc, lgt_block, hvy_block, hvy_neighbor, lgt_active, lgt_n, lgt_sortednumlist, hvy_active, hvy_n, 1, .true. )
!     ! refine the mesh to max grid-level
!     do l = 1, params_loc%max_treelevel
!         call refine_mesh( params_loc, lgt_block, hvy_block, hvy_neighbor, lgt_active, lgt_n, lgt_sortednumlist, hvy_active, hvy_n, "everywhere" )
!     end do
!
...
!     ! reset grid
!     !-----------------------------------------------------------------------
!     call reset_grid( params_loc, lgt_block, hvy_block, hvy_work, hvy_neighbor, lgt_active, lgt_n, hvy_active, hvy_n, lgt_sortednumlist, .false. )
!
!     !---------------------------------------------------------------------------
...
!         ! Note that active lists + neighbor relations are updated inside this routine as well, as
!         ! the grid is modified
!         call create_equidistant_base_mesh( params_loc, lgt_block, hvy_block, hvy_neighbor, lgt_active, lgt_n, lgt_sortednumlist, hvy_active, hvy_n, 1, .false. )
...
!                 call does_block_exist(lgt_block(lgt_id, 1:params_loc%max_treelevel), exists, lgt_id_old, l)
!
!                 ! old heavy id
