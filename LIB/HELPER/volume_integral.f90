...
! main body
   ...
   do k = 1, hvy_n
       ...
       if (params%threeD_case) then 
           int_block(1) = sum(hvy_block(g+1:Bs+g-1,g+1:Bs+g-1,g+1:Bs+g-1,1,hvy_active(k)))*dx(1)*dx(2)*dx(3)
           int_block(2) = sum(hvy_block(g+1:Bs+g-1,g+1:Bs+g-1,g+1:Bs+g-1,2,hvy_active(k)))*dx(1)*dx(2)*dx(3)
           int_block(3) = sum(hvy_block(g+1:Bs+g-1,g+1:Bs+g-1,g+1:Bs+g-1,3,hvy_active(k)))*dx(1)*dx(2)*dx(3)
       else
           int_block(1) = sum(hvy_block(g+1:Bs+g-1,g+1:Bs+g-1,1,1,hvy_active(k)))*dx(1)*dx(2)
           int_block(2) = sum(hvy_block(g+1:Bs+g-1,g+1:Bs+g-1,1,2,hvy_active(k)))*dx(1)*dx(2)
       end if
