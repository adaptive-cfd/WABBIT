...
subroutine create_random_grid( params, lgt_block, hvy_block, hvy_work, hvy_tmp, hvy_neighbor, lgt_active, &
    ...
    call create_equidistant_grid( params, lgt_block, hvy_block, hvy_neighbor, lgt_active(:,tree_ID_flow), &
    lgt_n(tree_ID_flow), lgt_sortednumlist(:,:,tree_ID_flow), hvy_active(:,tree_ID_flow), hvy_n(tree_ID_flow), 2, .true. )
    ...
    do l = 1, iterations
        ...
        call refine_mesh( params, lgt_block, hvy_block, hvy_tmp, hvy_neighbor, lgt_active(:,tree_ID_flow), lgt_n(tree_ID_flow), &
             lgt_sortednumlist(:,:,tree_ID_flow), hvy_active(:,tree_ID_flow), hvy_n(tree_ID_flow), "random" )
