...
subroutine refinement_execute_3D( params, lgt_block, hvy_block, hvy_active, hvy_n )
    ...
    if (REDUNDANT_GRID) then
        call refinement_execute_3D_redundantGrid( params, lgt_block, hvy_block, hvy_active, hvy_n )
    else
        call refinement_execute_3D_uniqueGrid( params, lgt_block, hvy_block, hvy_active, hvy_n )
    endif

end subroutine

subroutine refinement_execute_3D_redundantGrid( params, lgt_block, hvy_block, hvy_active, hvy_n )
    ...
    integer(kind=ik), intent(in)        :: hvy_active(:)                        !> list of active blocks (heavy data)
    integer(kind=ik), intent(in)        :: hvy_n                                !> number of active blocks (heavy data)
    integer(kind=ik)                    :: k, N, dF, lgt_id                     ! loop variables
...
subroutine refinement_execute_3D_uniqueGrid( params, lgt_block, hvy_block, hvy_active, hvy_n )
