...
! WABBIT
! ============================================================================================
! name: RMA_lock_unlock_get_data.f90
! version: 0.4
! author: msr
!
! get data from RMA window on other proc
...
subroutine RMA_lock_unlock_get_data( int_send_buffer, real_send_buffer, int_receive_buffer, real_receive_buffer, com_matrix, com_matrix_pos )
