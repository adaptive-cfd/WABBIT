...
module module_params
    ...
    type type_params
        ...
        character(len=80) :: wavelet="not-initialized", wavelet_transform_type="harten-multiresolution"
        ...
        character(len=80) :: order_predictor="not-initialized"
        ! order of spatial discretization
        character(len=80) :: order_discretization="not-initialized"
        ...
        ! physics
        ! -------------------------------------------------------------------------------------
        character(len=80) :: physics_type="not-initialized"
