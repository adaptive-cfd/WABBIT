...
!-----------------------------------------------------------------------------------------------------
    ...
    call read_attributes(params%input_files(1), lgt_n, time, iteration, params%domain_size, &
    ...
    do i = 1, params%n_eqn
      ...
      call read_attributes(file_in, lgt_n, time, iteration, domain, Bs, level, dim)
