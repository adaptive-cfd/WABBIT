...
subroutine post_derivative(params)
    ...
    if (der_order_i == 1 .and. der_dim_i == 1) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dx', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 1 .and. der_dim_i == 2) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dy', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 1 .and. der_dim_i == 3) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dz', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 2 .and. der_dim_i == 1) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dxdx', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 2 .and. der_dim_i == 2) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dydy', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 2 .and. der_dim_i == 3) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dzdz', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 11 .and. der_dim_i == 12) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dxdy', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 11 .and. der_dim_i == 13) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dxdz', int(time), nint((time-int(time))*1.0e6_rk)
    if (der_order_i == 11 .and. der_dim_i == 23) write( fname,'(a, "_", i6.6, i6.6, ".h5")') 'dzdz', int(time), nint((time-int(time))*1.0e6_rk)
