...
subroutine post_derivative(params)
    ...
    if (der_order_i == 1 .and. der_dim_i == 1) write( fname,'(a, "_", a, ".h5")') 'dx', trim(adjustl(timestr(time)))
    if (der_order_i == 1 .and. der_dim_i == 2) write( fname,'(a, "_", a, ".h5")') 'dy', trim(adjustl(timestr(time)))
    if (der_order_i == 1 .and. der_dim_i == 3) write( fname,'(a, "_", a, ".h5")') 'dz', trim(adjustl(timestr(time)))
    if (der_order_i == 2 .and. der_dim_i == 1) write( fname,'(a, "_", a, ".h5")') 'dxdx', trim(adjustl(timestr(time)))
    if (der_order_i == 2 .and. der_dim_i == 2) write( fname,'(a, "_", a, ".h5")') 'dydy', trim(adjustl(timestr(time)))
    if (der_order_i == 2 .and. der_dim_i == 3) write( fname,'(a, "_", a, ".h5")') 'dzdz', trim(adjustl(timestr(time)))
    if (der_order_i == 11 .and. der_dim_i == 12) write( fname,'(a, "_", a, ".h5")') 'dxdy', trim(adjustl(timestr(time)))
    if (der_order_i == 11 .and. der_dim_i == 13) write( fname,'(a, "_", a, ".h5")') 'dxdz', trim(adjustl(timestr(time)))
    if (der_order_i == 11 .and. der_dim_i == 23) write( fname,'(a, "_", a, ".h5")') 'dzdz', trim(adjustl(timestr(time)))
