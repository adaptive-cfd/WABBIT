...
$(OBJDIR)/module_ns_penalization.o: module_ns_penalization.f90 $(OBJDIR)/module_navier_stokes_params.o $(OBJDIR)/module_ini_files_parser_mpi.o\
	funnel.f90 vortex_street.f90 sod_shock_tube.f90 simple_shock.f90 RHS_2D_cylinder.f90
	$(FC) $(FFLAGS) -c -o $@ $< $(LDFLAGS)
...
$(OBJDIR)/module_mpi.o: module_mpi.f90 $(OBJDIR)/module_params.o $(OBJDIR)/module_debug.o $(OBJDIR)/module_interpolation.o\
	synchronize_ghosts.f90 blocks_per_mpirank.f90 reset_ghost_nodes.f90 synchronize_lgt_data.f90
	$(FC) $(FFLAGS) -c -o $@ $< $(LDFLAGS)
