...
function [data, time, error] = read_wabbit_hdf( filename )
    ...
    for i = 1 : nblocks
        ...
        [field, coord_x, coord_y, time, error] = read_block_HDF5( file_id, dsetname );
...
function [field, coord_x, coord_y, time, error] = read_block_HDF5( file_id, dsetname )
