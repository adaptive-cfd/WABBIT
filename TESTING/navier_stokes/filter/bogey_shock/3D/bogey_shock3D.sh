...
#-------------------------------------------------------------------------------
# what parameter file
dir="./TESTING/navier_stokes/filter/bogey_shock/3D/"
params=${dir}"bogey_shock3D.ini"
happy=0
sad=0
echo "Sod_shock_tube: testing bogey filter in 3D and euler equations"

# list of prefixes the test generates
prefixes=(rho Uz p mask)
