...
#-------------------------------------------------------------------------------
# what parameter file
dir="TESTING/navier_stokes/simple_geometry/rhombus/"
params=${dir}"rhombus_moving_shock.ini"
happy=0
sad=0
echo "testing ion funnel"
# list of prefixes the test generates
prefixes=(rho Ux Uy p vort mask)
# list of possible times (no need to actually have them)
times=(000000000000 000000000050 000000000100 )
