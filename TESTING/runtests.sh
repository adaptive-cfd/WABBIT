...
tests=( "---post---"
         "TESTING/wabbit_post/pod/pod_adaptive.sh"
         "TESTING/wabbit_post/pod/pod_reconstruct.sh"
         "---convection---"
        ...
        "---acm---"
        "TESTING/acm/new_acm_cyl_equi_4th/run.sh"
        "TESTING/acm/new_acm_cyl_adaptive_4th/run.sh"
        "TESTING/acm/new_acm_cyl_adaptive_4th_g3/run.sh"
        "TESTING/acm/new_acm_cyl_adaptive_4th_nosponge/run.sh"
        "TESTING/acm/new_acm_cyl_adaptive_2nd_g1/run.sh"
        "TESTING/acm/new_acm_cyl_adaptive_2nd_g2/run.sh"
        "TESTING/acm/pressure_blob_3D/run.sh"
        "TESTING/acm/pressure_blob_3D_nodealias/run.sh"
        "TESTING/acm/pressure_blob_2nd_3D/run.sh"
        "TESTING/acm/pressure_blob_2nd_3D_nodealias/run.sh"
        "TESTING/acm/bumblebee_adaptive_dry/run.sh"
        "TESTING/acm/bumblebee_adaptive_fluid/run.sh"
        )
