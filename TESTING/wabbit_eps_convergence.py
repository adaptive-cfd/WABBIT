...
#plt.close('all')
#
#do_test("B_SWIRL/adaptive2_swirl-easy","SWIRL-easy-4th-4th-4th (T=4.0, Jmax=13)")
#do_test("B_SWIRL/adaptive1_swirl-tough","SWIRL-tough-4th-4th-4th (T=10.0, CFL=1.0)")
#
#
#do_test("B_SWIRL/adapt_jmax4_swirl-easy","SWIRL-easy-4th-4th-4th (T=4.0, Jmax=4)")
#do_test("B_SWIRL/adapt_jmax5_swirl-easy","SWIRL-easy-4th-4th-4th (T=4.0, Jmax=5)")
#do_test("B_SWIRL/adapt_jmax6_swirl-easy","SWIRL-easy-4th-4th-4th (T=4.0, Jmax=6)")
#do_test("B_SWIRL/adapt_jmax7_swirl-easy","SWIRL-easy-4th-4th-4th (T=4.0, Jmax=7)")
#
#plt.figure(1)
#plt.grid()
#plt.xlabel('$\\varepsilon$')
